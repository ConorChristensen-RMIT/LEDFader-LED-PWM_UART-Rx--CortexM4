...
int main(void)
{
	int8_t old_number = 145;				
	int8_t recieved_character1;					
	int8_t recieved_character2;
	int8_t recieved_character3;
	int16_t recieved_number;
	uint16_t prescale;
	uint16_t prescale1s = 840;					
	uint16_t tim6_count = 50000;				
	uint16_t tim7_count = 1000;					
	uint16_t tim7_total_count = 1000;					
  ...
  while (1)
  {
		...
		if (recieved_number == 0x00) continue;											
		else if (recieved_number == 145) 
		{
			if (recieved_character2 == 49) prescale = 10*prescale1s; 
			else prescale = prescale1s;															 
		}
		else if (recieved_number == 153) prescale = 2*prescale1s; 
		else if (recieved_number == 152) prescale = 3*prescale1s; 
		else if (recieved_number == 151) prescale = 4*prescale1s; 
		else if (recieved_number == 150) prescale = 5*prescale1s; 
		else if (recieved_number == 149) prescale = 6*prescale1s; 
		else if (recieved_number == 148) prescale = 7*prescale1s; 
		else if (recieved_number == 147) prescale = 8*prescale1s; 
		else if (recieved_number == 146) prescale = 9*prescale1s; 
		else recieved_number = old_number;	
		...
		while ((((TIM_TypeDef *) (0x40000000U + 0x1000U))->SR & (0x1U << (0U))) == 0)					
		{
			...
			toggleLEDS();																				
			startSingleShotTIM7(prescale1s, tim7_total_count - tim7_count);		
			while ((((TIM_TypeDef *) (0x40000000U + 0x1400U))->SR & (0x1U << (0U))) == 0);								
			tim7_count -= 20;																		
		}
		toggleLEDS(); 
...
int8_t getCharacter()
{
	...
	if(((USART_TypeDef *) (0x40000000U + 0x4800U))->SR & (0x1U << (5U)))
	{
		...
		recieved = ((USART_TypeDef *) (0x40000000U + 0x4800U))->DR;
		...
		else if ((recieved == 0x0D) || (recieved == 0x0A))
		{
			valid = 1;
		}
...
void toggleLEDS(void)
{
	...
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->BSRR ^= ((0x1U << (3U)) | (0x1U << (8U)) | (0x1U << (9U)) | (0x1U << (10U)));
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->BSRR ^= ((0x1U << (0U)) | (0x1U << (1U)) | (0x1U << (8U)));
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U))->BSRR ^= (0x1U << (8U));
}
...
void startSingleShotTIM6(uint16_t pre_scale, uint16_t count)
{
	...
	((TIM_TypeDef *) (0x40000000U + 0x1000U))->PSC |= pre_scale;							
	((TIM_TypeDef *) (0x40000000U + 0x1000U))->ARR &= ~((0xFFFFFFFFU << (0U)));		
	((TIM_TypeDef *) (0x40000000U + 0x1000U))->ARR |= count;									
...
void startSingleShotTIM7(uint16_t pre_scale, uint16_t count)
{
	...
	((TIM_TypeDef *) (0x40000000U + 0x1400U))->PSC |= pre_scale;							
	((TIM_TypeDef *) (0x40000000U + 0x1400U))->ARR &= ~((0xFFFFFFFFU << (0U)));		
	((TIM_TypeDef *) (0x40000000U + 0x1400U))->ARR |= count;									
